...
void doStack() {
  ...
  TH1D* h1_Rch_vs_eta = (TH1D*)inFile->Get("Rch_vs_eta_50_80_PFItCone5");
  TH1D* h1_Rgamma_vs_eta = (TH1D*)inFile->Get("Rgamma_vs_eta_50_80_PFItCone5");
  TH1D* h1_Rnh_vs_eta = (TH1D*)inFile->Get("Rnh_vs_eta_50_80_PFItCone5");
  TH1D* h1_Rmu_vs_eta = (TH1D*)inFile->Get("Rmu_vs_eta_50_80_PFItCone5");
  TH1D* h1_Rhf_vs_eta = (TH1D*)inFile->Get("Rhf_vs_eta_50_80_PFItCone5");
  ...
  h1_Rmu_vs_eta_stack->SetFillColor(kCyan);
  ...
  c1->cd();
  stack->Draw();
  c1->SaveAs("Plots/stack_vs_eta_50_80.eps");
