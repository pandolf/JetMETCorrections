...
int main( int argc, char* argv[] ) {
  ...
  if( argc!=2 && argc!=3 && argc!=4 && argc!=5 ) {
    std::cout << "USAGE: ./finalize_QGStudies [dataset] [dijet_analysis=false] [iBlock=1] [nBlocks=1]" << std::endl;
    return 13;
  }
  ...
  TreeFinalizerC_QGStudies* tf = new TreeFinalizerC_QGStudies( dataset, 0.2, "pf", "akt5", iBlock, nBlocks );
